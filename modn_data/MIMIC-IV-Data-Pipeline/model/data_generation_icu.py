...
class Generator():
    def __init__(self,cohort_output,if_mort,if_admn,if_los,feat_cond,feat_proc,feat_out,feat_chart,feat_med,impute,include_time=24,bucket=1,predW=6, for_modn=False):
        ...
        self.smooth_meds(bucket, for_modn)
    ...
    def smooth_meds(self,bucket, for_modn):
...
#         else:
        self.create_Dict(final_meds,final_proc,final_out,final_chart,los, for_modn)
    ...
    def create_Dict(self,meds,proc,out,chart,los, for_modn=False):
        dataDic={}
        print(los)
